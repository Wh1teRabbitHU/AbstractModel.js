...
function constructor(instance, attributes, values) {
	...
	let attrValidationObject = objectUtil.isValidAttributes(instance._attributes, moduleUtil.options.modelRoot);

	if (!attrValidationObject.isValid) {
		throw new InvalidTypeException('One of your predefined attribute has wrong custom type!', {
			invalidAttributes: attrValidationObject.invalidAttributes
		});
	}
